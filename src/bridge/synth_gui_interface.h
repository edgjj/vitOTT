...
class SynthGuiInterface : public juce::Component {
public:
    SynthGuiInterface(SynthBase& base, SynthSection* section);

    SynthBase* getSynth();
    void resized() override;

private:
    SynthBase& _fake_base;

    std::unique_ptr<FullInterface> _gui;
